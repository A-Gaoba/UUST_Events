...
const Dashboard = ({ user }) => {
  ...
  return (
    <div className="flex items-center justify-center h-auto mt-6 w-full">
      <div className={"flex justify-center flex-col " + display}>
        {user ? (
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded mb-4 w-40 self-center"
          >
            Add Event
          </button>
        ) : (
