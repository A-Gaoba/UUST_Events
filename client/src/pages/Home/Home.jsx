...
import heroImg from '../../assets/heero.jpg'

function Home({ user }) {
  let navigate = useNavigate();
  
  return (
    <div className="flex flex-col lg:flex-row justify-center items-center px-4 lg:px-20  h-screen">
      ...
      <div className="lg:w-1/3 my-5 mx-6">
        <img
